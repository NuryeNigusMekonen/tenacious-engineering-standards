...
1. **Write and self-check** - the [Engineering Baseline](engineering-baseline-standard.md).
2. **Open a PR and merge into protected branches** - [Branch Strategy](branching-standard.md) and [Pull Requests](pull-request-standard.md).
3. **The infrastructure that makes environments safe** - [Key Management](secrets-management-standard.md) and [CI/CD](ci-cd-standard.md).
4. **Prove the change works** - [Manual Testing](manual-testing-standard.md) then [Automation Testing](automation-testing-standard.md).
5. **Ship it** - [Release Management](release-management-standard.md).
